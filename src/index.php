            ...
            <div class="card m-2">
                ...
                <div class="card-footer d-flex justify-content-around">
                    ...
                    <button type="button" class="btn btn-outline-secondary border-0"><i
                            class="bi bi-pencil-square d-block" style="font-size: 1rem;"></i>
                        commento</button>
                    <button type="button" class="btn btn-outline-secondary border-0 d-block" style="font-size: 1rem;"><i
                            class="bi bi-shared-block" style="font-size: 1rem;"></i>
                        condividi</button>
