        ...
        <div class="collapse navbar-collapse " id="navbarTogglerDemo03">
            <ul class="navbar-nav mx-auto text-center">
                <li class="nav-item px-2">
                    <a class="nav-link  " href="index.php"><i class="bi bi-house d-md-inline d-lg-block" style="font-size: 1.5rem;"></i>Home</a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link " href="#"><i class="bi bi-people d-md-inline d-lg-block" style="font-size: 1.5rem;"></i>Group</a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link " href="contacts.php"><i class="bi bi-people d-md-inline d-lg-block" style="font-size: 1.5rem;"></i>Contacts</a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link " href="signin.html"><i class="bi bi-people d-md-inline d-lg-block" style="font-size: 1.5rem;"></i>Sign in</a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link " href="signup.html"><i class="bi bi-people d-md-inline d-lg-block" style="font-size: 1.5rem;"></i>Sign up</a>
                </li>
            </ul>
